<template>
  ...
  <div class="app-container">
    ...
    <el-button type="text" @click="dialogChapterFormVisible = true;chapter = {...DefaultChapterForm}">添加章节</el-button>
    <!-- 添加和修改章节表单 -->
...
export default {
  ...
  methods: {
    ...
    helpSave(){
      ...
      this.fetchChapterNestedListByCourseId()// 刷新列表
      this.chapter = {...this.DefaultChapterForm}
